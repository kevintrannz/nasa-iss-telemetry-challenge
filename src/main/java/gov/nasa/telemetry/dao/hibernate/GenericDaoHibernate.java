...
import gov.nasa.telemetry.dao.SearchException;
 ...
 * <pre>
 *      &lt;bean id="fooDao" class="gov.nasa.telemetry.dao.hibernate.GenericDaoHibernate"&gt;
 *          &lt;constructor-arg value="gov.nasa.telemetry.model.Foo"/&gt;
 *      &lt;/bean&gt;
 * </pre>
 *
