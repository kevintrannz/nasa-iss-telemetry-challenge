...
import gov.nasa.telemetry.dao.UserDao;
import gov.nasa.telemetry.model.User;
import gov.nasa.telemetry.service.MailEngine;
import gov.nasa.telemetry.service.UserExistsException;
import gov.nasa.telemetry.service.UserManager;
import gov.nasa.telemetry.service.UserService;
 ...
 */
@Service("userManager")
@WebService(serviceName = "UserService", endpointInterface = "gov.nasa.telemetry.service.UserService")
public class UserManagerImpl extends GenericManagerImpl<User, Long> implements UserManager, UserService {
     ...
     * @see gov.nasa.telemetry.service.MailEngine#sendMessage(org.springframework.mail.SimpleMailMessage, String, java.util.Map)
     */
