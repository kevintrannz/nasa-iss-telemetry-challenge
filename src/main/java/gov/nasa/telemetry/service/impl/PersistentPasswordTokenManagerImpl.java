...
public class PersistentPasswordTokenManagerImpl implements PasswordTokenManager {
    ...
    /**
     * @see gov.nasa.telemetry.service.impl.PasswordTokenManager#generateRecoveryToken(gov.nasa.telemetry.model.User)
     */
    @Override
    ...
    /**
     * @see gov.nasa.telemetry.service.impl.PasswordTokenManager#isRecoveryTokenValid(gov.nasa.telemetry.model.User, java.lang.String)
     */
    @Override
    ...
    /**
     * 
     * @see gov.nasa.telemetry.service.impl.PasswordTokenManager#invalidateRecoveryToken(User, String)
     */
    @Override
